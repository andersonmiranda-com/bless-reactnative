                ...
                <Content style={styles.container}>
                    <View style={styles.listView}>
                        ...
                        <ListItem selected={this.state.radio2} onPress={() => this.toggleRadio2()}>
                            <Left>
                                <Text style={styles.radioText}>Software Engineer at GeekyAnts</Text>
                            </Left>
                            <Right>
                                <Radio
                    ...
                    <View style={styles.noteView}>
                        <Text style={styles.noteText}>
                            If your current job isn't shown, please update it on facebook and it
                            will appear here. If you're looking for a new job, work at Tinder.
                        </Text>
                    </View>
                    <View style={styles.listView}>
                        <ListItem>
